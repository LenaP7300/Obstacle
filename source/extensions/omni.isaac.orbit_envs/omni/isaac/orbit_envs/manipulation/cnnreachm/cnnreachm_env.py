...
from .cnnreachm_cfg import RandomizationCfg, ReachEnvCfg
...
class ReachEnv(IsaacEnv):
    ...
    def _initialize_views(self) -> None:
        ...
        self.cylinder.initialize(self.env_ns + "/.*/Cylinder", track_contact_forces=True, prepare_contact_sensors=True)
...
class ReachRewardManager(RewardManager):
    ...
    def hitting_object_l2(self, env: ReachEnv):
        print(env.cylinder.objects.get_net_contact_forces())
