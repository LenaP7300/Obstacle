...
from .multireach_cfg import RandomizationCfg, ReachEnvCfg


class ReachEnv(IsaacEnv):
    """Environment for reaching to desired pose for a single-arm manipulator."""

    def __init__(self, only_image: bool = False, res: int = 0, image_type: str = "rgb", logdir: str = None, video: bool = False, cfg: ReachEnvCfg = None, headless: bool = False):
        # copy configuration
        self.cfg = cfg
        self.logdir = logdir
