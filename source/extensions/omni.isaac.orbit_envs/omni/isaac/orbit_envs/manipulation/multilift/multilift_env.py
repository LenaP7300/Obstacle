...
from .multilift_cfg import LiftEnvCfg, RandomizationCfg


class LiftEnv(IsaacEnv):
    """Environment for lifting an object off a table with a single-arm manipulator."""

    def __init__(self, only_image: bool = False, res: int = 0, image_type: str = "rgb", logdir: str = None, video: bool = False, cfg: LiftEnvCfg = None, headless: bool = False):
    ...
    def env_image(self):
        ...
        for rp in self.rp_list:
            ...
            if len(image) != 0:
                ...
                if self.video and self.step_count % (100 * self.num_envs) == 0:
