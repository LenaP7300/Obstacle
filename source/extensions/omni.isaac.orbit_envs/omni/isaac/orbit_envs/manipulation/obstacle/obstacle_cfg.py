...
class CubeCfg(RigidObjectCfg):
    ...
    rigid_props = RigidObjectCfg.RigidBodyPropertiesCfg(
        ...
        max_depenetration_velocity=0.000001,
        disable_gravity=True,
    )
    physics_material = RigidObjectCfg.PhysicsMaterialCfg(
        static_friction=0.0, dynamic_friction=0.0, restitution=1.0, prim_path="/World/Materials/cubeMaterial"
    )
