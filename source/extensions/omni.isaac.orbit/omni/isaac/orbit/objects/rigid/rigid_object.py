...
class RigidObject:
    ...
    * Storing data related to the rigid object.
    ...
    def initialize(self, prim_paths_expr: Optional[str] = None, track_contact_forces=False, prepare_contact_sensors=False):
        ...
        # create handles
        # -- object views
        self.objects = RigidPrimView(prim_paths_expr,
