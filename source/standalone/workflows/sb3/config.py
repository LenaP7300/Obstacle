...
SB3_PPO_CONFIG_FILE = {
    ...
    "Isaac-CnnCartpole-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/cnncartpole_ppo.yaml"),
    "Isaac-MultiCartpole-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/multicartpole_ppo.yaml"),
    "Isaac-Ant-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/ant_ppo.yaml"),
    "Isaac-CnnAnt-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/cnnant_ppo.yaml"),
    "Isaac-MultiAnt-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/multiant_ppo.yaml"),
    ...
    "Isaac-Obstacle-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/obstacle_ppo.yaml"),
    "Isaac-ReachM-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/reach_ppo.yaml"),
    "Isaac-CnnReachM-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/cnnreach_ppo.yaml"),
    "Isaac-MultiReachM-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/multireach_ppo.yaml"),
    "Isaac-Lift-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/reach_ppo.yaml"),
    "Isaac-MultiLift-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/multilift_ppo.yaml"),
    "Isaac-CnnLift-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/cnnlift_ppo.yaml"),
    "Isaac-MultiReach-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/multireach_ppo.yaml"),
    "Isaac-CnnReach-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/cnnreach_ppo.yaml"),
    # velocity
    "Isaac-Velocity-Anymal-C-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/velocity_ppo.yaml"),
}
